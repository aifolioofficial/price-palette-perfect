...
const products = [
  {
    ...
    description: "A responsive, modern WordPress theme for businesses and portfolios.",
    image: "/placeholder.svg?height=200&width=350",
    price: "$49",
    category: "WordPress",
    url: "https://codecanyon.net/item/your-product-1",
    demoUrl: "https://demo.yoursite.com/product-1",
    sales: 124,
    rating: 4.8,
  },
  {
